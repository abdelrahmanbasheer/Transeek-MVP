...
const page = () => {
    ...
    const { register, handleSubmit } = useForm<IFormInput>({
      ...
      const onSubmit= async (formData:IFormInput)=>{
        ...
        try {
          const response = await axios.post('http://localhost:3000/auth/signup/exporter', formData, {
            headers: {
    ...
    <div className='flex'>
        ...
        <div className='flex flex-col mt-10 w-[500px]  mx-auto'>
            ...
            <label className='text-[#313131] text-sm  z-50 left-5 top-[150px] absolute bg-white'> type Of Goods </label>
            <input  className='p-4 border-2 border-[#79747E] rounded-md w-[537px] h-[56px] outline-none' {...register("typeOfGoods")} />
            </div>
