          ...
          <div className="w-[416px] h-[700px] bg-white border-[#EDEDED] border-[1px] rounded-lg p-6">
            ...
            <div className="flex justify-between  p-6 items-center">
              <div>
                ...
                <h1 className="text-[#717171] text-sm my-1">Discount</h1>
                <h1 className="text-[#717171] text-sm my-1">Shipment cost</h1>
              </div>
              <div>
                <h1 className="text-[#717171] text-sm">$519.52</h1>
                <h1 className="text-[#ff0000] text-sm">$111.87</h1>
                <h1 className="text-[#717171] text-sm"> $22.50</h1>
              </div>
            </div>
            <hr />
            <div className="flex justify-between p-6">
              <h1 className="text-md">Grand Total</h1>
              <h1 className="text-md font-semibold">$430.15</h1>
            </div>
            <Dialog>
              {payment === "paypal" ? (
