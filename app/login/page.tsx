...
const page = () => {
  ...
  return (
    <div className='flex'>
       ...
       <div className=''>
            <input onClick={()=>setCurr("exporter")} className='' type="radio" id="option1" name="option" value="1"/>
            <label className='ml-3 mb-3'>Exporter</label><br />
            <input onClick={()=>setCurr("freightForwarder")} type="radio" id="option2" name="option" value="2"/>
